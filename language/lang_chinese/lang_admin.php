...
'admin_general_email_cfg' =>  '&raquo; 信箱設定',
...
'configuration_version_current' =>  '您現在使用的是最新版的WRM',
'configuration_version_info_header' =>  '版本資訊',
'configuration_version_outdated_header' =>  '有新版的WRM可以更新!',
'configuration_version_outdated_message' =>  '您的WRM已經是舊版的了. 強烈建議您立即更新.<br>
...
'configuration_debug' =>  '除蟲模式',
'configuration_disable' =>  '關閉活動報名系統',
'configuration_enable_five_man' =>  '允許五人隊伍<br><a href="../docs/enable_groups.htm" target="_blank">help?</a>',
...
'configuration_admin_email' =>  '管理者信箱',
'configuration_email_header' =>  '信箱設定',
'configuration_email_sig' =>  '信箱簽名檔',

'configuration_rss_header' =>  'RSS Configuration',
'configuration_rss_site' =>  'RSS:WRM安裝網址 (網址尾端不得輸入 /)',
'configuration_rss_export' =>  'RSS:輸出RSS資料至網站',
'configuration_rss_feed_amt' =>  'RSS:於RSS資料顯示之團隊數量',
...
'configuration_logo' =>  'Logo鏈結位址',
'configuration_sitelink' =>  '"頁首" 連結',
'configuration_template' =>  '版面',
...
'configuration_date' =>  '日期格式<br><a href="http://www.php.net/date/" target="_blank">幫助?</a>',
'configuration_dst_text' =>  '日光節約時間?',
'configuration_time' =>  '時間格式 <br><a href="http://www.php.net/date/" target="_blank">help?</a>',
'configuration_timezone_text' =>  '時區',
...
'configuration_role_header' =>  '角色設定',
'addrole' =>  'Add Role',
...
'configuration_roster_text' =>  '與WoW Roster整合',
...
'configuration_armory_link_text' =>  '正確伺服器ARMORY連結',
'configuration_armory_language_text' =>  'Armory語言碼',
...
'configuration_multiple' =>  '允許多重報名',
'configuration_anonymous' =>  '允許遊客瀏覽',
'configuration_resop' =>  '使韌性成為非必須選項',

// Text on the "Signup Rights" Page.
'configuration_raid_signupgroups_header' =>  'Raid Permission Groups',
'configuration_cancel' =>  '取消',
'configuration_cancel_def' =>  '取消 = 將使用者移動至取消區域',
'configuration_cancelled' =>  '取消狀態',
'configuration_comments' =>  '建議',
'configuration_comments_def' =>  '建議 = 允許使用者編輯建議',
'configuration_delete' =>  '刪除',
'configuration_delete_def' =>  '刪除 = 完全移除使用者登記',
'configuration_draft_def' =>  '參加 = 將使用者放置於參予團隊區',
'configuration_draft' =>  '參加',
'configuration_drafted' =>  '參加 (已列入團隊)',
'configuration_on_queue' =>  '後補中',
'configuration_queue' =>  '後補',
'configuration_queue_def' =>  '候補 = 將使用者放置於候補區',
'configuration_signup_rights_header' =>  '報名權限',
'configuraiton_admin' =>  '管理者',
'configuration_raidlead' =>  '團隊指揮',

// Text on the "Raid Settings" Page.
'configuration_raid_settings_header' =>  '團隊設定',
...
'configuration_role_limit_text' =>  '強制團隊職責限制',
'configuration_class_limit_text' =>  '強制團隊職業數量限制',
'configuration_class_as_min' =>  '各職業限制最少數量',
'configuration_freeze' =>  '關閉報名至檢查時間',
...
'configuration_description' =>  '描述',
'configuration_default' =>  '預設群組',
'configuration_faction' =>  '陣營',
'configuration_guild_header' =>  '公會設定',
'configuration_guild_name' =>  '名稱',
'configuration_id' =>  '在列表中顯示ID',
'configuration_server' =>  '伺服器',
'configuration_site_header' =>  '網站設定',
'configuration_user' =>  '使用者',
'configuration_user_rights_header' =>  '使用者權限',

// multiple use
'configuration_autoqueue' =>  '報名時自動進入候補',
