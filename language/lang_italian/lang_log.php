...
$phprlang['log_raid'] = '%s - %s: l\'Utente [<a href="users.php?mode=details&amp;user_id=%s">%s</a> (%s)] ha alterato il Raid <a href="raid_view.php?mode=view&amp;raid_id=%s">%s %s</a>: [%s] del Personaggio %s - %s';
?>