...
$phprlang['configuration_ampm'] = 'Planlegg raid med 24 timers klokke';
$phprlang['configuration_anonymous'] = 'Tillate anonym visning';
$phprlang['configuration_armory_enable'] = 'Aktiver Armory oppslag';
$phprlang['configuration_armory_link_text'] = 'Rett armory ling for server';
$phprlang['configuration_armory_language_text'] = 'Språk kode for Armory';
$phprlang['configuration_autoqueue'] = 'Ikke tillat signup til utkast';
$phprlang['configuration_cancel'] = 'Kanseler';
$phprlang['configuration_cancel_def'] = 'Kanseler = Plasser bruker i kansellert område';
$phprlang['configuration_cancelled'] = 'Kanselert Status';
$phprlang['configuration_comments'] = 'Kommentarer';
$phprlang['configuration_comments_def'] = 'Kommentarer = Tillat brukere til å endre kommentarer';
$phprlang['configuration_date'] = 'Dato format<br><a href="http://www.php.net/date/" target="_blank">help?</a>';
$phprlang['configuration_description'] = 'Beskrivelse';
$phprlang['configuration_debug'] = 'Debug modus';
$phprlang['configuration_default'] = 'Vanlig gruppe';
$phprlang['configuration_delete'] = 'Slett';
$phprlang['configuration_delete_def'] = 'Slett = Fjern påmeldingen fullstendig';
$phprlang['configuration_disable'] = 'Deaktiver WRM';
$phprlang['configuration_draft_def'] = 'Utkast = Plasserer bruker i deltagende område';
$phprlang['configuration_draft'] = 'Utkast';
$phprlang['configuration_drafted'] = 'Utkastet (I Raid)';
$phprlang['configuration_dst_text'] = 'Sommertid?';
$phprlang['configuration_email_header'] = 'E-post konfigurasjon';
$phprlang['configuration_email_sig'] = 'E-post signatur';
$phprlang['configuration_enable_five_man'] = 'Aktiver grupper<br><a href="docs/enable_groups.htm" target="_blank">jhelp?</a>';
$phprlang['configuration_eqdkp_integration_text'] = 'Integrer med EqDKP<br><a href="docs/eqdkp_link.htm" target="_blank">hjelp?</a>';
$phprlang['configuration_eqdkp_link'] = 'URL til EqDKP Installasjon (ingen etterfølgende /)';
$phprlang['configuration_external_links_header'] = 'Integrasjon med eksterne systemer';
$phprlang['configuration_faction'] = 'Faction';
$phprlang['configuration_freeze'] = 'Deaktiver lås skjekking';
$phprlang['configuration_guild_header'] = 'Guild konfigurering';
$phprlang['configuration_guild_name'] = 'Navn';
$phprlang['configuration_id'] = 'Vis id i tabell';
$phprlang['configuration_language'] = 'Språk';
$phprlang['configuration_logo'] = 'Sti til logo bilde';
$phprlang['configuration_multiple'] = 'Tillat flere påmeldinger';
$phprlang['configuration_on_queue'] = 'I Kø';
$phprlang['configuration_queue'] = 'Kø';
$phprlang['configuration_queue_def'] = 'Kø = Plasser bruker i kø området';
$phprlang['configuration_raid_settings_header'] = 'Raid Innstillninger';
...
$phprlang['configuration_raidlead'] = 'Raid Leder';
$phprlang['configuration_resop'] = 'Gjør resistance valgfritt';
$phprlang['configuration_register_text'] = 'Registrerings URL';
$phprlang['configuration_role_header'] = 'Rolle Konfigurasjon';
$phprlang['configuration_role1_text'] = 'Klasse Rolle #1';
$phprlang['configuration_role2_text'] = 'Klasse Rolle #2';
$phprlang['configuration_role3_text'] = 'Klasse Rolle #3';
$phprlang['configuration_role4_text'] = 'Klasse Rolle #4';
$phprlang['configuration_role5_text'] = 'Klasse Rolle #5';
$phprlang['configuration_role6_text'] = 'Klasse Rolle #6';
$phprlang['configuration_role_limit_text'] = 'Tvinge rolle begrensninger for Raid';
$phprlang['configuration_class_limit_text'] = 'Tvinge Class begrensninger for Raid';
$phprlang['configuration_class_as_min'] = 'Bruk Class begrensninger som Minimum';
$phprlang['configuration_roster_text'] = 'Intigrer med WoW Roster';
$phprlang['configuration_rss_site'] = 'RSS: URL til WRM  installasjon (Ingen endende /)';
$phprlang['configuration_rss_export'] = 'RSS: Side til å eksportere RSS feed til';
$phprlang['configuration_rss_feed_amt'] = 'RSS: Antall raid å vise i Feed';
$phprlang['configuration_server'] = 'Server';
$phprlang['configuration_show_addon'] = 'Vis addon link';
$phprlang['configuration_signup_rights_header'] = 'Påmelding tilganger';
$phprlang['configuration_site_header'] = 'Side konfigurasjon';
$phprlang['configuration_sitelink'] = '"Hjem" Link peker til';
$phprlang['configuration_template'] = 'Mal';
$phprlang['configuration_time'] = 'Tidsformat<br><a href="http://www.php.net/date/" target="_blank">hjelp?</a>';
$phprlang['configuration_timezone_text'] = 'Tidssone';
$phprlang['configuration_user'] = 'Bruker';
$phprlang['configuration_user_rights_header'] = 'Bruker tilganger';
$phprlang['configuration_version_current'] = 'Du har nyeste versjon av WRM';
$phprlang['configuration_version_info_header'] = 'Versjon Informasjon';
$phprlang['configuration_version_outdated_header'] = 'WoW Raid Manager oppdatering tilgjengelig!';
$phprlang['configuration_version_outdated_message'] = 'Din versjon av WoW Raid Manager er utdatert. Det er anbefalt å oppdatere.<br>
													   Nyeste versjon er %s og du har %s.<br>
													   For å laste ned, gå til <a href="http://www.wowraidmanager.net">www.wowraidmanager.net</a>.';
...
$phprlang['lua_download'] = 'Last ned phpRaidViewer';
