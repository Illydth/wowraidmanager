...
ALTER TABLE `wrm_raids` ADD `raid_force_name` VARCHAR( 100 ) NOT NULL DEFAULT 'None'; 
...
ALTER TABLE `wrm_locations` ADD `raid_force_name` VARCHAR( 100 ) NOT NULL DEFAULT 'None',
