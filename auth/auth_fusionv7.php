 ...
 *                            -------------------
 *   begin                : Dez 29, 2010
 *	 Dev                  : Le-Thor (www.wowraidmanager.net)
 *	 email                : le-thor@le-thor.dk
 *
...
$db_table_allgroups = "user_groups";
...
function db_password_change($profile_id, $dbusernewpassword)
{
	...
	// fusionv7 Specific Password Mangling
	/* 
	 * For fusionv7 This is very simple, it uses a straight MD5 password hash.
	 */
...
function password_check($oldpassword, $profile_id, $encryptflag)
{
	...
	{ // Non-encrypted password sent in, encrypt and check against DB.
		//We have the password now, now for fusionv7 Specific Password Mangling
		/* 
